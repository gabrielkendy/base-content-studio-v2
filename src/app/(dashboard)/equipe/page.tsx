...
import type { Member, Invite } from '@/types/database'

export default function EquipePage() {
  const { org, member: currentMember, supabase } = useAuth()
  ...
  async function loadData() {
    const { data: mems } = await supabase.from('members').select('*').eq('org_id', org!.id)
    setMembers(mems || [])
