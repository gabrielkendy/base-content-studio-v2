    ...
    try {
      ...
      if (authData.user) {
        ...
        if (checkoutData.url) {
          ...
          // No checkout URL → route through session-transfer to set domain cookie
          window.location.href = `/api/auth/session-transfer?dest=${encodeURIComponent('/clientes?welcome=true')}`
        }
      }
    } catch (err: any) {
      ...
      <div className="flex-1 flex flex-col justify-center px-8 lg:px-16 py-12">
        <div className="max-w-md mx-auto w-full">
          ...
          <Link href="/" className="flex items-center gap-3 mb-12">
            ...
            <span className="text-xl font-bold">BASE Content Studio</span>
          </Link>
